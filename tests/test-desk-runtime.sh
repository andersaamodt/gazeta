...
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" '<path class="desk-map-greenbelt-strip" d="' 'Desk outdoor rooms use the same greenbelt strip class as the building perimeter'
...
assert_file_not_contains "$ROOT_DIR/site/static/desk-page.css" 'stroke-width: 68;' 'Desk outdoor room greenery does not use a separate edge width'
