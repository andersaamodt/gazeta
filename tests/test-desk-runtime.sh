...
assert_file_not_contains "$ROOT_DIR/site/static/desk-page.js" 'desk-map-greenbelt-gradient' 'Desk greenbelt does not use a directional strip gradient'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'farthestCorner * 1.08' 'Desk lamp gradients reach across the whole clipped room floor'
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'Math.hypot(light.x - x1' 'Desk lamp light radius is measured from each lamp source'
...
assert_file_not_contains "$ROOT_DIR/site/static/desk-page.js" 'desk-map-greenbelt-outer-fade' 'Desk greenbelt does not render a visibly separate outer fade strip'
assert_file_not_contains "$ROOT_DIR/site/static/desk-page.js" 'desk-map-greenbelt-core' 'Desk greenbelt does not render a visibly separate solid core strip'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.css" 'stroke-width: 92;' 'Desk greenbelt has one broader band with room for the far edge to fade gradually'
assert_file_contains "$ROOT_DIR/site/static/desk-page.css" 'filter: url(#desk-map-greenery-blur);' 'Desk greenbelt fades at its edge without separate visible strips'
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'stdDeviation="13"' 'Desk greenbelt uses a wider blur for a more gradual fade'
assert_file_contains "$ROOT_DIR/site/static/desk-page.css" 'stroke: #9fac63;' 'Desk greenbelt uses a warmer spring yellow-green in a single band'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.css" 'stroke-width: 68;' 'Desk outdoor room greenery edges fade out more gradually'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'beginMapRoomRename(roomPath);' 'Desk map room title double-clicks open inline rename for any room'
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'if (roomPath === state.currentRoom)' 'Desk map room double-clicks ignore the current room instead of reopening its notepad'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" "beginMapRoomRename(roomPath);" 'Desk map double-click edits any room title instead of opening the notepad'
