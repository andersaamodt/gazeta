...
assert_file_contains "$ROOT_DIR/site/pages/desk.md" '20260530-todo-nav-polish1' 'Desk page cache-busts latest Desk todo and navigation polish'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'data-desk-map-greenbelt-tone' 'Desk map exposes a greenbelt color toggle next to zoom'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'function renderGreenbeltToneIcon' 'Desk map greenbelt toggle shows the two available greens'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'desk_greenbelt_tone_v1' 'Desk remembers the greenbelt color toggle locally'
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" "state.greenbeltTone === 'deep' ? '#87954f' : '#9fac63'" 'Desk greenbelt toggle offers the darker and lighter greens'
