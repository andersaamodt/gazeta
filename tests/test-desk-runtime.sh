...
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'setRoom(clickedRoom, false, { preserveOpenPaper: true })' 'Desk map room clicks keep an open notepad or compose page visible'
