...
assert_file_contains "$ROOT_DIR/site/pages/desk.md" 'desk-greenbelt1' 'Desk page cache-busts the connected outdoor greenbelt styling'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'rgba(122,66,37,0.2)' 'Desk map room parchment texture has warmer grid lines'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'desk-map-greenbelt-meadow' 'Desk map connects garden areas with shared grass meadows'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.css" '.desk-map-greenbelt-field' 'Desk map has a greenbelt field layer behind the rooms'
assert_file_contains "$ROOT_DIR/site/static/desk-page.css" '.desk-map-greenbelt-wash' 'Desk map greenbelt fades back into parchment at the edges'
