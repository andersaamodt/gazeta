...
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'desk-map-greenbelt-outer-fade' 'Desk greenbelt renders a soft outer fade around the perimeter'
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'desk-map-greenbelt-core' 'Desk greenbelt keeps a solid planting band under the fade'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.css" 'stroke-width: 82;' 'Desk greenbelt outer edge fades with a wider soft stroke'
assert_file_contains "$ROOT_DIR/site/static/desk-page.css" 'filter: url(#desk-map-greenery-blur);' 'Desk greenbelt outer edge uses a soft blur fade'
