...
assert_file_contains "$ROOT_DIR/site/pages/desk.md" '20260529-desk-nav-icons1' 'Desk page cache-busts latest Desk interface updates'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'var gradientWidth = 60;' 'Desk greenbelt outer edge fade is wide and gradual'
