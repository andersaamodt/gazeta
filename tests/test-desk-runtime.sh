...
assert_file_contains "$ROOT_DIR/site/pages/desk.md" 'desk-perimeter-parchment1' 'Desk page cache-busts perimeter greenery and parchment refinements'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.css" '.desk-map-scroll-art' 'Desk map launcher keeps the diagonal scroll tilt in the artwork'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'desk-map-scroll-back' 'Desk map launcher has a clearer tucked scroll underside'
