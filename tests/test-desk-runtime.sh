...
assert_file_contains "$ROOT_DIR/site/static/desk-page.css" 'stroke-width: 70;' 'Desk greenbelt has one broad band with room for the far edge to fade'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.css" 'stroke: #87936a;' 'Desk greenbelt keeps the muted rustic map green in a single band'
