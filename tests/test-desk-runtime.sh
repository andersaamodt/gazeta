...
assert_css_block_contains "$ROOT_DIR/site/static/desk-page.css" '.desk-map-create-btn,' 'box-shadow: none;' 'Desk map buttons force off box shadows'
assert_css_block_contains "$ROOT_DIR/site/static/desk-page.css" '.desk-map-create-btn,' 'background: transparent;' 'Desk map buttons are icon-only at rest'
assert_css_block_contains "$ROOT_DIR/site/static/desk-page.css" '.desk-map-create-btn,' 'background-color: transparent;' 'Desk map buttons force off resting button surfaces'
...
assert_css_block_contains "$ROOT_DIR/site/static/desk-page.css" '.desk-map-create-btn,' 'background: transparent;' 'Desk map utility icons have no square idle background'
assert_css_block_contains "$ROOT_DIR/site/static/desk-page.css" '.desk-map-create-btn,' 'background-image: none;' 'Desk map utility icons suppress inherited button chrome while idle'
