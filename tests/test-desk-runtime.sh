...
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'desk-map-greenbelt-strip desk-map-greenbelt-fade' 'Desk greenbelt renders a co-located soft outer fade behind the opaque band'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.css" 'stroke-width: 62;' 'Desk greenbelt restores a thinner opaque main band'
assert_file_contains "$ROOT_DIR/site/static/desk-page.css" 'stroke-width: 82;' 'Desk greenbelt reserves only the outer edge for a gentle fade'
...
assert_file_contains "$ROOT_DIR/site/static/desk-page.css" 'filter: url(#desk-map-greenery-blur);' 'Desk greenbelt fades only at the outer edge'
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'stdDeviation="10"' 'Desk greenbelt uses a gentle blur for a gradual outer edge'
