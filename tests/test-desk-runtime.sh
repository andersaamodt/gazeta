...
assert_file_contains "$ROOT_DIR/site/static/desk-page.css" 'margin: 0 0 0.45rem -2.6rem;' 'Desk room properties title offsets the button-footprint padding to center over the panel'
