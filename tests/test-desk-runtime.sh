...
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'var gradientOverlap = 3;' 'Desk greenbelt fade overlaps the opaque band to avoid one-pixel parchment gaps'
assert_file_contains "$ROOT_DIR/site/static/desk-page.js" 'var gradientCapOverlap = gradientOverlap;' 'Desk greenbelt fade rectangles slightly overlap at segment ends instead of showing cut-edge seams'
