...
assert_file_contains "$SITE_SOURCE_ROOT/static/style.css" 'background: var(--post-tag-type-bg) !important;' 'type post tag chip recovery keeps the blue treatment'
assert_file_contains "$SITE_SOURCE_ROOT/static/style.css" 'background: var(--post-tag-year-bg) !important;' 'year post tag chip recovery keeps the green treatment'
