...
assert_file_contains "$ROOT_DIR/cgi/blog-open-post" 'style_css_version='"'"'20260621-parchment-tags1'"'" 'direct post fallback uses the current style cache key'
...
assert_file_contains "$ROOT_DIR/cgi/blog-delivery" '/static/style.css?v=20260621-parchment-tags1' 'delivery page uses the current style cache key'
