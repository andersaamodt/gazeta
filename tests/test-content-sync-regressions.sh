...
assert_file_contains "$SITE_SOURCE_ROOT/includes/nav.md" 'vendor/citrine-nostr-web.js?v=20260622-citrine1' 'Citrine helper is loaded before nav auth'
assert_file_contains "$SITE_SOURCE_ROOT/includes/nav.md" 'nav-auth.js?v=20260622-citrine1' 'nav-auth include is cache-busted for Citrine adoption'
...
assert_file_contains "$SITE_SOURCE_ROOT/includes/footer.md" 'v0.7.24' 'footer exposes current site version before GitHub'
...
assert_file_contains "$SITE_SOURCE_ROOT/includes/nav.md" 'nav-auth.js?v=20260622-citrine1' 'nav auth script URL is cache-busted after Citrine adoption'
...
assert_file_not_contains "$SITE_SOURCE_ROOT/includes/nav.md" 'id="auth-nip46-open" class="auth-inline-link" href="#" target="_blank"' 'Nostr Connect link avoids target blank so Android can open signer apps reliably'
