...
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" "blog_nostr_blog_page_js_version='20260611-blog-defaulttag-prerender1'" 'blog page script cache buster tracks default-tag prerender updates'
...
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" "blog_nostr_list_page_js_version='20260602-list-syncstatus2'" 'list page script cache buster tracks sync-status and public-entry delete fixes'
