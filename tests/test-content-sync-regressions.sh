...
assert_file_contains "$SITE_SOURCE_ROOT/static/style.css" 'Shared soft action buttons: borderless tan controls with the Open Chat shadow.' 'title action admin buttons use the shared soft action style'
...
assert_file_contains "$SITE_SOURCE_ROOT/static/themes/lapidarist.css" 'Shared soft action buttons: borderless tan controls with the Open Chat shadow.' 'Lapidarist title action admin buttons use the shared soft action style'
