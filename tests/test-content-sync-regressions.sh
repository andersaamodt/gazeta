...
assert_file_contains "$SITE_SOURCE_ROOT/includes/nav.md" 'nav-auth.js?v=20260622-login-signer-neutral1' 'nav-auth include is cache-busted for signer-neutral login fix'
...
assert_file_contains "$SITE_SOURCE_ROOT/includes/footer.md" 'v0.7.22' 'footer exposes current site version before GitHub'
...
assert_file_contains "$SITE_SOURCE_ROOT/includes/nav.md" 'nav-auth.js?v=20260622-login-signer-neutral1' 'nav auth script URL is cache-busted after signer-neutral login update'
...
assert_file_contains "$SITE_SOURCE_ROOT/includes/nav.md" 'nav-auth.js?v=20260622-login-signer-neutral1' 'nav auth include is cache-busted for signer-neutral login update'
