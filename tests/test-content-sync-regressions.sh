...
assert_file_contains "$SITE_SOURCE_ROOT/static/video-chat-widget.js" "WIDGET_BUILD_VERSION = '20260525-soft-actions1'" 'video chat widget publishes the soft-action button build version'
assert_file_contains "$SITE_SOURCE_ROOT/static/contact-page.js" "videoChatWidgetBuildVersion = '20260525-soft-actions1'" 'contact page loads the soft-action video widget build'
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" '<script src="/static/video-chat-widget.js?v=20260525-soft-actions1" data-video-chat-widget="1"></script>' 'contact page HTML loads the video widget before contact-page hydration'
