...
assert_file_contains "$SITE_SOURCE_ROOT/includes/head.html" '20260621-parchment-restore2' 'head theme stylesheet cache buster tracks parchment texture fixes'
...
assert_file_contains "$SITE_SOURCE_ROOT/static/admin.js" '20260621-parchment-restore2' 'admin theme preview cache buster tracks parchment texture fixes'
...
assert_file_contains "$SITE_SOURCE_ROOT/includes/footer.md" 'v0.7.4' 'footer exposes current site version before GitHub'
...
assert_file_contains "$SITE_SOURCE_ROOT/includes/head.html" 'background: var(--post-tag-year-bg, #dcecff) !important;' 'shared head recovery forces year pills light blue'
...
assert_file_contains "$SITE_SOURCE_ROOT/static/nav-auth.js" '20260621-parchment-restore2' 'auth theme switcher uses current parchment texture theme cache buster'
...
assert_file_contains "$ROOT_DIR/cgi/blog-open-post" "style_css_version='20260621-parchment-restore2'" 'single post fallback route cache-busts the parchment and tag styles'
...
assert_file_contains "$ROOT_DIR/cgi/blog-delivery" "style_css_version='20260621-parchment-restore2'" 'delivery page cache-busts the restored parchment and tag styles'
