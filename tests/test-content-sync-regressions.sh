...
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" "blog_nostr_blog_page_js_version='20260525-post-type-labels1'" 'blog page script cache buster tracks post type label fixes'
...
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" "blog_nostr_list_page_js_version='20260525-list-stability1'" 'list page script cache buster tracks list stability fixes'
