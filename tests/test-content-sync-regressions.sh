...
assert_file_contains "$SITE_SOURCE_ROOT/static/contact-page.js" 'video-chat-widget.js?v=20260524-room-themes1' 'contact page loads the scheduled-room video widget build'
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" '<script src="/static/video-chat-widget.js?v=20260524-room-themes1" data-video-chat-widget="1"></script>' 'contact page HTML loads the video widget before contact-page hydration'
