...
assert_file_contains "$SITE_SOURCE_ROOT/static/contact-page.js" 'Calling unavailable' 'contact page renders a visible fallback when the call widget cannot mount'
...
assert_file_contains "$SITE_SOURCE_ROOT/static/nav-auth.js" '20260525-soft-actions1' 'auth theme switcher uses current soft action theme cache buster'
