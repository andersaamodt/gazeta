...
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" "blog_nostr_blog_page_js_version='20260602-blog-syncstatus1'" 'blog page script cache buster tracks sync-status title action updates'
