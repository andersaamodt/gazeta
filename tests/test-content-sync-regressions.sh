...
assert_file_contains "$SITE_SOURCE_ROOT/includes/nav.md" 'nav-auth.js?v=20260622-nip46-pubkey-retry1' 'nav-auth include is cache-busted for NIP-46 pubkey retry fix'
...
assert_file_contains "$SITE_SOURCE_ROOT/includes/footer.md" 'v0.7.23' 'footer exposes current site version before GitHub'
...
assert_file_contains "$SITE_SOURCE_ROOT/includes/nav.md" 'nav-auth.js?v=20260622-nip46-pubkey-retry1' 'nav auth script URL is cache-busted after NIP-46 pubkey retry update'
...
assert_file_contains "$SITE_SOURCE_ROOT/includes/nav.md" 'nav-auth.js?v=20260622-nip46-pubkey-retry1' 'nav auth include is cache-busted for NIP-46 pubkey retry update'
