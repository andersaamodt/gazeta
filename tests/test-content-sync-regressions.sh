...
assert_file_contains "$SITE_SOURCE_ROOT/static/style.css" '--post-tag-type-bg: #dcecff;' 'post type chips use light blue'
assert_file_contains "$SITE_SOURCE_ROOT/static/style.css" '--post-tag-year-bg: #dff4d7;' 'post year chips use light green'
...
assert_file_contains "$ROOT_DIR/cgi/blog-open-post" '/static/style.css?v=20260615-post-sync-pill1' 'single post fallback route cache-busts the sync pill header styles'
