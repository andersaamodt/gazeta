...
assert_file_contains "$SITE_SOURCE_ROOT/includes/nav.md" 'nav-auth.js?v=20260526-desk-notifications1' 'nav auth include is cache-busted for Desk notification polling'
