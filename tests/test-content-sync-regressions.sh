...
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" "blog_nostr_contact_page_js_version='20260525-call-loading-mockup1'" 'contact page cache buster tracks call loading mockup recovery'
...
assert_file_contains "$SITE_SOURCE_ROOT/static/style.css" '--list-vote-up-color: #d4a41d;' 'default upvotes use a yellow first-paint color'
assert_file_contains "$SITE_SOURCE_ROOT/static/themes/lapidarist.css" '--list-vote-up-color: #d4a41d;' 'Lapidarist upvotes use a yellow first-paint color'
...
assert_file_contains "$SITE_SOURCE_ROOT/includes/nav.md" 'nav-auth.js?v=20260526-desk-notifications1' 'nav auth script URL is cache-busted after Desk notification polling'
