...
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" "blog_nostr_list_page_js_version='20260621-list-file-link-parity1'" 'list page script cache buster tracks file link parity fixes'
