...
assert_file_contains "$SITE_SOURCE_ROOT/static/contact-page.js" 'data-video-chat-call-label="Call Anders"' 'video chat widget owner call button names the direct call action'
...
assert_file_contains "$SITE_SOURCE_ROOT/static/video-chat-widget.js" 'voiceIconHtml + escapeHtml(ownerLabel)' 'voice owner call button shows an icon with the shared owner label'
assert_file_contains "$SITE_SOURCE_ROOT/static/video-chat-widget.js" 'videoIconHtml + escapeHtml(ownerLabel)' 'video owner call button shows an icon with the shared owner label'
