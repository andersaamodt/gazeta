...
assert_file_contains "$SITE_SOURCE_ROOT/includes/footer.md" 'v0.7.25' 'footer exposes current site version before GitHub'
...
assert_file_contains "$SITE_SOURCE_ROOT/static/nav-auth.js" 'window.CitrineNostrWeb.buildNostrConnectUri' 'Nostr Connect link generation uses Citrine when available'
