...
assert_file_contains "$SITE_SOURCE_ROOT/includes/head.html" '20260604-post-width-tags1' 'post resize cache buster tracks post width and tag cleanup'
...
assert_file_contains "$ROOT_DIR/cgi/blog-open-post" '/static/style.css?v=20260604-post-width-tags1' 'single post fallback route cache-busts the post width and tag CSS'
