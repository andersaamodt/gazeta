...
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" "blog_nostr_list_page_js_version='20260621-list-prerender-parity1'" 'list page script cache buster tracks list prerender parity fixes'
...
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" 'md_inline_link_label(label) or html.escape(url, quote=True)' 'list page prerender uses post_url label rendering like hydration'
...
assert_file_contains "$SITE_SOURCE_ROOT/includes/head.html" '20260620-parchment-textures1' 'head theme stylesheet cache buster tracks parchment texture fixes'
...
assert_file_contains "$SITE_SOURCE_ROOT/static/admin.js" '20260620-parchment-textures1' 'admin theme preview cache buster tracks parchment texture fixes'
...
assert_file_contains "$SITE_SOURCE_ROOT/static/nav-auth.js" '20260620-parchment-textures1' 'auth theme switcher uses current parchment texture theme cache buster'
