...
assert_file_contains "$SITE_SOURCE_ROOT/includes/head.html" '20260525-heading-nav-fix1' 'head theme stylesheet cache buster tracks heading/nav fixes'
assert_file_contains "$SITE_SOURCE_ROOT/static/admin.js" '20260525-heading-nav-fix1' 'admin theme preview cache buster tracks heading/nav fixes'
...
assert_file_contains "$SITE_SOURCE_ROOT/static/nav-auth.js" '20260525-heading-nav-fix1' 'auth theme switcher uses current heading/nav theme cache buster'
