...
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" "blog_nostr_contact_page_js_version='20260524-contact-zap-data1'" 'contact page cache buster tracks contact zap data and drag rendering'
