...
assert_file_contains "$PAGE" '/static/artificer-web-page.css?v=20260529-artificer-web3' "artificer page loads cache-busted shell styles"
assert_file_contains "$PAGE" '/static/artificer-web-page.js?v=20260529-artificer-web2' "artificer page loads cache-busted shell script"
...
assert_file_contains "$JS" "data-artificer-settings" "shell renders an Artificer settings menu"
assert_file_contains "$JS" "data-artificer-logout" "settings menu includes logout"
