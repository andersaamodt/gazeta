...
assert_file_contains "$PAGE" '/static/artificer-web-page.css?v=20260529-artificer-web5' "artificer page loads cache-busted shell styles"
assert_file_contains "$PAGE" '/static/artificer-web-page.js?v=20260529-artificer-web5' "artificer page loads cache-busted shell script"
