...
assert_file_contains "$SITE_SOURCE_ROOT/includes/nav.md" 'nav-auth.js?v=20260429-amber-open1' 'nav auth script URL is cache-busted after Amber deep-link dispatch fix'
