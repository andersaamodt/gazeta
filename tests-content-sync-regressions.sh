...
assert_file_contains "$SITE_SOURCE_ROOT/static/nav-auth.js" "intro: 'Connect Nostr with the link or QR. Sign-in continues after pairing.'" 'Android phone signer guidance says pairing continues automatically'
