...
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" "blog_nostr_list_page_js_version='20260523-score-sort1'" 'list page script cache buster tracks score sorting and row animation'
