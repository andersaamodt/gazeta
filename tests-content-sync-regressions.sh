...
assert_file_contains "$ROOT_DIR/static/public-ranking-page.js" 'data-ranking-action="toggle-submit-advanced"' 'public ranking submit composer includes admin advanced toggle'
...
assert_file_contains "$ROOT_DIR/static/public-ranking-page.js" "if (isAdmin()) {" 'public ranking type selector is admin-only'
