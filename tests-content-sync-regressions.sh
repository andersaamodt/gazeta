...
assert_file_contains "$SITE_SOURCE_ROOT/static/nav-auth.js" 'window.location.href = href;' 'Nostr Connect deep link opens in the current mobile browser context'
