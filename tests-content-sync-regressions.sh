...
assert_file_contains "$SITE_SOURCE_ROOT/static/nav-auth.js" "Recommended: Amber from F-Droid." 'Android phone signer guidance recommends Amber through F-Droid'
