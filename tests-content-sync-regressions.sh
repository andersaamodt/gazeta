...
assert_file_contains "$SITE_SOURCE_ROOT/includes/nav.md" 'nav-auth.js?v=20260429-phone-signer1' 'nav auth script URL is cache-busted after phone signer wording fix'
