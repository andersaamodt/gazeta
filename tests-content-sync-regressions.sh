...
assert_file_contains "$SITE_SOURCE_ROOT/static/contact-page.js" 'video-chat-widget.js?v=20260523-contact-headings1' 'contact page loads the contact-heading video widget build'
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" '<script src="/static/video-chat-widget.js?v=20260523-contact-headings1" data-video-chat-widget="1"></script>' 'contact page HTML loads the video widget before contact-page hydration'
...
assert_file_contains "$SITE_SOURCE_ROOT/static/style.css" 'background-image: none !important;' 'navbar search button does not use parchment or texture backgrounds'
...
assert_file_contains "$SITE_SOURCE_ROOT/static/themes/lapidarist.css" 'height: 40px !important;' 'Lapidarist navbar search button keeps full circular height'
...
assert_file_contains "$SITE_SOURCE_ROOT/static/nav-auth.js" '20260523-nav-content-width1' 'auth theme switcher uses current login menu theme cache buster'
