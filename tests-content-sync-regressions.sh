...
assert_file_contains "$SITE_SOURCE_ROOT/static/nav-auth.js" "return isMobileLikeRuntime() ? 'phone' : 'register';" 'primary login uses phone signer tab first on mobile without desktop signer'
