...
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" "blog_nostr_contact_page_js_version='20260523-contact-headings3'" 'contact page cache buster tracks contact heading rendering'
