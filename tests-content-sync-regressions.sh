...
assert_file_contains "$SITE_SOURCE_ROOT/static/contact-page.js" 'video-chat-widget.js?v=20260523-invite-panel1' 'contact page loads the invite-panel video widget build'
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" '<script src="/static/video-chat-widget.js?v=20260523-invite-panel1" data-video-chat-widget="1"></script>' 'contact page HTML loads the video widget before contact-page hydration'
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" "blog_nostr_contact_page_js_version='20260523-invite-panel1'" 'contact page cache buster tracks invite panel rendering'
