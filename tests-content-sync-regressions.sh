...
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" "blog_nostr_contact_page_js_version='20260523-contact-headings2'" 'contact page cache buster tracks contact heading rendering'
assert_file_contains "$ROOT_DIR/cgi/blog-nostr-pages-common.sh" "blog_nostr_simplex_web_default_chat_js_version='20260523-contact-heading2'" 'shared Secure Chat renderer cache buster tracks contact heading rendering'
...
assert_file_contains "$SITE_SOURCE_ROOT/static/nav-auth.js" 'navRight.appendChild(els.navOverflowMenu);' 'navbar overflow button is kept inside the right controls lane'
assert_file_contains "$SITE_SOURCE_ROOT/static/style.css" 'order: 99;' 'navbar overflow button is ordered after other right controls'
...
assert_file_contains "$SITE_SOURCE_ROOT/static/nav-auth.js" '20260523-menu-items3' 'auth theme switcher uses current login menu theme cache buster'
