...
assert_file_contains "$ROOT_DIR/site/static/overworld-game.js" '/static/overworld-godot/v20260523-zoom-default/index.html' 'web game mounts Godot export'
assert_file_exists "$ROOT_DIR/site/static/overworld-godot/v20260523-zoom-default/index.html" 'Godot export HTML exists'
assert_file_exists "$ROOT_DIR/site/static/overworld-godot/v20260523-zoom-default/index.pck" 'Godot export package exists'
