...
assert_file_contains "$ROOT_DIR/site/static/overworld-game.js" '/static/overworld-godot/v20260522-mobile-compact/index.html' 'web game mounts Godot export'
assert_file_exists "$ROOT_DIR/site/static/overworld-godot/v20260522-mobile-compact/index.html" 'Godot export HTML exists'
assert_file_exists "$ROOT_DIR/site/static/overworld-godot/v20260522-mobile-compact/index.pck" 'Godot export package exists'
assert_file_contains "$ROOT_DIR/site/static/overworld-game.js" 'Download (6.9 MB)' 'web game advertises compressed opt-in download size'
assert_file_contains "$ROOT_DIR/site/static/overworld-game.js" 'startDownload' 'web game gates Godot export behind explicit download action'
assert_file_contains "$ROOT_DIR/site/static/overworld-game.js" 'frame.src = GODOT_URL' 'web game starts Godot iframe only after opt-in'
