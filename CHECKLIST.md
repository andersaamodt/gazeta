...
- [ ] Unify admin and admin-read auth/session/request parsing into one shared security authority.
- [ ] Centralize site path and environment resolution across all runtimes.
