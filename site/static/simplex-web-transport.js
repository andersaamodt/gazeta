    ...
    return {
      ...
      sendFiles: function (message, options) {
        ...
        return callAdapterMethod(target, 'sendFiles', [Object.assign({}, normalized, {
          ...
          wait_for_native_file_accept: message && message.wait_for_native_file_accept,
          waitForNativeFileAccept: message && message.waitForNativeFileAccept,
          native_file_accept_timeout_ms: message && message.native_file_accept_timeout_ms,
          nativeFileAcceptTimeoutMs: message && message.nativeFileAcceptTimeoutMs,
          file_accept_timeout_ms: message && message.file_accept_timeout_ms,
          fileAcceptTimeoutMs: message && message.fileAcceptTimeoutMs,
          file_chunk_size: message && message.file_chunk_size,
          fileChunkSize: message && message.fileChunkSize,
          file_queue_mode: message && message.file_queue_mode,
          fileQueueMode: message && message.fileQueueMode
        })]);
      },
