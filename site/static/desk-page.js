(function () {
  ...
  function renderModeDock() {
    return '<div class="desk-mode-dock" aria-label="Desk modes">' +
      '<button type="button" class="desk-mode-launch desk-mode-map' + (state.mode === 'map' && state.closingMode !== 'map' ? ' is-active' : '') + '" data-desk-mode="map" aria-label="' + (state.mode === 'map' && state.closingMode !== 'map' ? 'Close room map' : 'Open room map') + '" aria-pressed="' + (state.mode === 'map' && state.closingMode !== 'map' ? 'true' : 'false') + '"><svg class="desk-map-scroll-icon" viewBox="0 0 72 72" aria-hidden="true"><g class="desk-map-scroll-art"><path class="desk-map-scroll-shadow" d="M11 61C21 51 42 39 62 34"></path><path class="desk-map-scroll-back" d="M15 51C24 40 39 31 56 27l8 16c-19 5-34 12-45 23z"></path><path class="desk-map-scroll-body" d="M9 49C19 36 36 24 58 21l-4 26C34 48 21 55 12 66z"></path><path class="desk-map-scroll-roll" d="M55 21c6-3 12-2 14 2 2 4-2 8-11 10"></path><path class="desk-map-scroll-curl" d="M12 66c7-4 14-5 22-4"></path><path class="desk-map-scroll-grid" d="M18 45l31-17M21 55l30-16M24 36l5 24M38 28l5 23"></path><path class="desk-map-scroll-route" d="M17 50c7-8 13 2 21-7 5-6 9-7 15-6"></path></g></svg></button>' +
      '<button type="button" class="desk-mode-launch desk-mode-compose' + (state.mode === 'compose' ? ' is-active' : '') + '" data-desk-mode="compose" aria-label="Compose on the desk"><svg class="desk-compose-quill-icon" viewBox="0 0 256 256" aria-hidden="true"><path fill="currentColor" d="m229.66 58.34l-32-32a8 8 0 0 0-11.32 0l-96 96A8 8 0 0 0 88 128v32a8 8 0 0 0 8 8h32a8 8 0 0 0 5.66-2.34l96-96a8 8 0 0 0 0-11.32M124.69 152H104v-20.69l64-64L188.69 88ZM200 76.69L179.31 56L192 43.31L212.69 64ZM224 128v80a16 16 0 0 1-16 16H48a16 16 0 0 1-16-16V48a16 16 0 0 1 16-16h80a8 8 0 0 1 0 16H48v160h160v-80a8 8 0 0 1 16 0"></path></svg></button>' +
