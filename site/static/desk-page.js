(function () {
  ...
  function renderMap(data) {
    ...
    var roomClipPaths = rooms.map(function (room) {
      var path = String(room.path || '');
      ...
      if (roomIsOutdoor(room)) {
        return '<clipPath id="' + roomClipId(path) + '"><rect x="' + x + '" y="' + y + '" width="' + unitW + '" height="' + unitH + '" rx="10"></rect></clipPath>';
      }
      return '<clipPath id="' + roomClipId(path) + '"><path d="' + architecturalRoomPath(x, y, unitW, unitH, exterior, path || 'office') + '"></path></clipPath>';
    }).join('');
    ...
    return '<section class="desk-mode-panel desk-map-panel' + (state.closingMode === 'map' ? ' is-closing' : '') + '" aria-label="Room map">' +
      ...
      '<defs><radialGradient id="desk-map-presence-glow" cx="50%" cy="47%" r="76%"><stop offset="0" stop-color="#ffce76" stop-opacity="0.92"></stop><stop offset="0.42" stop-color="#ffbe5c" stop-opacity="0.38"></stop><stop offset="1" stop-color="#ffb14b" stop-opacity="0"></stop></radialGradient><radialGradient id="desk-map-presence-glow-outdoor" cx="50%" cy="46%" r="78%"><stop offset="0" stop-color="#ffed89" stop-opacity="0.86"></stop><stop offset="0.44" stop-color="#ffdd70" stop-opacity="0.34"></stop><stop offset="1" stop-color="#ffd969" stop-opacity="0"></stop></radialGradient><pattern id="desk-map-parchment-texture" width="96" height="96" patternUnits="userSpaceOnUse"><rect width="96" height="96" fill="#dcc17f"></rect><path d="M4 16C25 11 42 20 64 13S87 8 96 13M0 58C20 53 39 63 60 56s27-11 38-4M16 90C33 82 54 93 76 85" stroke="rgba(116,69,31,0.11)" stroke-width="1.3" fill="none"></path><path d="M20 0v96M68 0v96M0 31h96M0 77h96" stroke="rgba(255,244,194,0.07)" stroke-width="1" fill="none"></path></pattern><pattern id="desk-map-grid" width="28" height="28" patternUnits="userSpaceOnUse"><path d="M 28 0 L 0 0 0 28" stroke="rgba(84,55,28,0.23)" stroke-width="1" fill="none"></path></pattern><pattern id="desk-map-room-paper" width="28" height="28" patternUnits="userSpaceOnUse"><rect width="28" height="28" fill="#d7b46f"></rect><path d="M 28 0 L 0 0 0 28" stroke="rgba(112,57,31,0.22)" stroke-width="1" fill="none"></path></pattern><pattern id="desk-map-grass" width="72" height="72" patternUnits="userSpaceOnUse"><rect width="72" height="72" fill="#7d9b5f"></rect><circle cx="12" cy="14" r="9" fill="rgba(129,169,101,0.35)"></circle><circle cx="54" cy="18" r="13" fill="rgba(83,124,70,0.22)"></circle><circle cx="32" cy="52" r="16" fill="rgba(158,184,106,0.28)"></circle><circle cx="70" cy="62" r="18" fill="rgba(65,105,61,0.2)"></circle></pattern><linearGradient id="desk-map-grass-fade-n" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#dcc17f" stop-opacity="0.76"></stop><stop offset="1" stop-color="#dcc17f" stop-opacity="0"></stop></linearGradient><linearGradient id="desk-map-grass-fade-e" x1="1" y1="0" x2="0" y2="0"><stop offset="0" stop-color="#dcc17f" stop-opacity="0.76"></stop><stop offset="1" stop-color="#dcc17f" stop-opacity="0"></stop></linearGradient><linearGradient id="desk-map-grass-fade-s" x1="0" y1="1" x2="0" y2="0"><stop offset="0" stop-color="#dcc17f" stop-opacity="0.76"></stop><stop offset="1" stop-color="#dcc17f" stop-opacity="0"></stop></linearGradient><linearGradient id="desk-map-grass-fade-w" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#dcc17f" stop-opacity="0.76"></stop><stop offset="1" stop-color="#dcc17f" stop-opacity="0"></stop></linearGradient>' + roomClipPaths + '</defs>' +
