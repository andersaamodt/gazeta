(function () {
  ...
  function renderModeDock() {
    return '<div class="desk-mode-dock" aria-label="Desk modes">' +
      '<button type="button" class="desk-mode-launch desk-mode-map' + (state.mode === 'map' && state.closingMode !== 'map' ? ' is-active' : '') + '" data-desk-mode="map" aria-label="' + (state.mode === 'map' && state.closingMode !== 'map' ? 'Close room map' : 'Open room map') + '" aria-pressed="' + (state.mode === 'map' && state.closingMode !== 'map' ? 'true' : 'false') + '"><svg class="desk-map-scroll-icon" viewBox="0 0 64 64" aria-hidden="true"><path class="desk-map-scroll-shadow" d="M6 57C18 49 38 38 58 33"></path><path class="desk-map-scroll-body" d="M9 52C21 43 39 34 56 30L49 16C31 20 16 28 4 38Z"></path><path class="desk-map-scroll-roll" d="M45 18c6-3 13-2 15 2 2 4-2 8-9 10"></path><path class="desk-map-scroll-grid" d="M15 40l32-14M21 47l31-14M21 34l8 15M34 28l8 14"></path><path class="desk-map-scroll-route" d="M16 43c8-8 14 2 22-7 5-5 8-5 13-4"></path></svg></button>' +
