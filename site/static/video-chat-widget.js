(function () {
  ...
  var WIDGET_BUILD_VERSION = '20260525-soft-actions2';
  ...
  VideoChatWidget.prototype._render = function () {
    ...
    var style = ''
      ...
      + '.vcw-btn{appearance:none;-webkit-appearance:none;border:0;background:var(--action-soft-bg,#f5e4d7);background-image:none;background-clip:padding-box;-webkit-background-clip:padding-box;background-origin:padding-box;color:var(--action-soft-text,#6d3a20);border-radius:var(--action-soft-radius,8px);padding:var(--action-soft-padding-y,.36rem) var(--action-soft-padding-x,.74rem);cursor:pointer;font-family:var(--action-soft-font-family,var(--ui-font-family,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif));font-size:var(--action-soft-font-size,.92rem);font-weight:var(--action-soft-font-weight,400);line-height:var(--action-soft-line-height,1.22);display:inline-flex;align-items:center;gap:6px;width:fit-content;min-width:0;box-shadow:var(--action-soft-shadow,0 .36rem .82rem rgba(48,34,16,.16));}'
      + '.vcw-btn:hover,.vcw-btn:focus-visible{background:var(--action-soft-hover-bg,#f0d7c5);background-image:none;color:var(--action-soft-hover-text,#5b2f18);box-shadow:var(--action-soft-hover-shadow,0 .42rem .95rem rgba(48,34,16,.18));}'
      + '.vcw-btn:disabled{opacity:0.55;cursor:default;}'
      + '.vcw-btn.vcw-btn-primary{background:var(--action-soft-bg,#f5e4d7);background-image:none;background-clip:padding-box;-webkit-background-clip:padding-box;background-origin:padding-box;color:var(--action-soft-text,#6d3a20);}'
      + '.vcw-btn.vcw-btn-primary:hover,.vcw-btn.vcw-btn-primary:focus-visible{background:var(--action-soft-hover-bg,#f0d7c5);background-image:none;background-clip:padding-box;-webkit-background-clip:padding-box;background-origin:padding-box;color:var(--action-soft-hover-text,#5b2f18);}'
      + '.vcw-btn .vcw-icon{display:inline-block;width:14px;height:14px;stroke:currentColor;stroke-width:1.9;fill:none;}'
      + '.vcw-call-owner-btn{width:42px;height:42px;justify-content:center;padding:0;}'
      + '.vcw-call-owner-btn .vcw-icon{width:18px;height:18px;}'
    ...
    this.shadowRoot.innerHTML = ''
      ...
      + '      <button type="button" class="vcw-btn vcw-btn-primary vcw-call-owner-btn vcw-voice-call-owner-btn" aria-label="Voice ' + escapeAttr(ownerLabel) + '" title="Voice ' + escapeAttr(ownerLabel) + '">' + voiceIconHtml + '</button>'
      + '      <button type="button" class="vcw-btn vcw-btn-primary vcw-call-owner-btn vcw-video-call-owner-btn" aria-label="Video ' + escapeAttr(ownerLabel) + '" title="Video ' + escapeAttr(ownerLabel) + '">' + videoIconHtml + '</button>'
