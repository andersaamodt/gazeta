(function () {
  const GODOT_URL = '/static/overworld-godot/v20260522-mobile-compact/index.html';
  const DOWNLOAD_LABEL = 'Download (6.9 MB)';
...
.overworld-godot-splash {
  ...
  background:
    ...
    url("/static/overworld-godot/v20260522-mobile-compact/index.png") center / min(48%, 320px) no-repeat,
    #101310;
}
...
@media (max-width: 720px) {
  ...
  .overworld-godot-splash {
    ...
    background:
      ...
      url("/static/overworld-godot/v20260522-mobile-compact/index.png") center / min(62%, 240px) no-repeat,
      #101310;
  }
  .overworld-godot-splash-panel {
    gap: 8px;
